"""
InventIP — inventory_management.py  (the Streamlit dashboard UI)

FILE MAP — search the banner text to jump to a section:
  1. IMPORTS & PAGE CONFIG .... app.py functions + browser tab settings
  2. CSS STYLES ............... all custom look & feel (cards, navbar, colors)
  3. CONSTANTS ................ status / risk / category color maps
  4. HELPERS .................. badges, ABC classes, INR format, chart colors
  5. CACHED LOADERS ........... ML models (pkl) + CSV data, cached for speed
  6. GLOBAL VARS .............. data, today, cutoff, snapshot, monthly
  7. TOP NAVIGATION ........... InventIP brand + 3 page links + back-to-top
  8. SIDEBAR .................. data zone stats + ML model status
  9. VIEW 1b — MATERIAL DETAIL  per-material page (opens when a card is clicked)
 10. VIEW 1  — OPERATIONAL DASHBOARD  KPI cards, health grid, charts, open POs
 11. VIEW 2  — INVENTORY INSIGHTS     6 analysis tabs
 12. VIEW 3  — PLANNING & FORECAST    90-day forward view + model performance
 13. VIEW 4  — PROCUREMENT PLAN       supplier choice + raising POs

Run with:  streamlit run inventory_management.py
(Models come from model.py — run `python model.py` after data changes.)
"""
...
from app import (
    ...
    get_daily_consumption, get_running_stock, get_monthly_consumption,
...
.st-key-nav_insights button,.st-key-nav_planning button,.st-key-nav_procure button{color:#475569;font-weight:600;white-space:nowrap;}
.st-key-nav_insights button p,.st-key-nav_planning button p,.st-key-nav_procure button p{font-size:1.2rem;font-weight:600;}
.st-key-nav_insights button:hover,.st-key-nav_planning button:hover,.st-key-nav_procure button:hover{color:#1B3A6B;}
...
nav_cols = st.columns([2.6, 1.25, 1.25, 1.15], vertical_alignment="center")
with nav_cols[0]:
